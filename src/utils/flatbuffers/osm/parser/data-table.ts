...
geohashElementsNodes(obj?:GeohashTree):GeohashTree|null {
...
static addGeohashElementsNodes(builder:flatbuffers.Builder, geohashElementsNodesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(1, geohashElementsNodesOffset, 0);
}
